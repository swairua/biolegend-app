...
const sidebarItems: SidebarItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { title: 'Loyalty Points', icon: CreditCard, href: '/settings/loyalty' },
...
export function AppSidebar() {
  ...
  return (
    <Sidebar>
      <SidebarHeader className="flex items-center border-b border-sidebar-border px-6 py-4">
        <BiolegendLogo size="lg" pixelSize={120} showText={false} className="text-sidebar-foreground" />
      </SidebarHeader>

      <SidebarContent className="flex-1 space-y-2 p-4 custom-scrollbar overflow-y-auto">
